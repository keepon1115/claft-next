        ...
        <div className="relative z-10 p-8">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-y-12 gap-x-16">
            ...
            <section className="bg-white/90 backdrop-blur-sm border-3 border-amber-600 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 min-h-[360px]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-stretch flex-grow">
                <div className="bg-gradient-to-br from-purple-100 to-indigo-100 rounded-2xl p-6 h-full flex flex-col">
                  ...
                  <div className="text-amber-700 text-sm space-y-1 mb-4">
                    <p>テーマ「虹の色って、いくつある？ (仮)」</p>
                    <p>📅 4/7(火) 20時~21時</p>
                  </div>
                  <a href="https://forms.gle/D4uRDUThVW365Aqr6" target="_blank" rel="noopener noreferrer" className="mt-auto bg-gradient-to-r from-purple-400 to-indigo-400 text-white font-bold py-2 px-4 rounded-lg hover:shadow-md transition-all duration-300">
                    参加する
                  </a>
                </div>
              ...
              <a href="https://keepon.my.canva.site/weekly-keepon3-13/" target="_blank" rel="noopener noreferrer" className="mt-4 group block text-center w-full bg-gradient-to-r from-yellow-400 to-orange-400 text-amber-900 font-bold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
