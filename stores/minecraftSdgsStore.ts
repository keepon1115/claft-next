...
const defaultStageDetails: Record<number, MinecraftStageProgress> = {
  ...
  3: {
    ...
    sdgsStageDownloadUrl: 'https://xgf.nu/fKGm2',
    programmingWorkUrl: 'https://youtu.be/M8P1tOZIc6s?si=2ozWBzsVjqx3INMh',
    programmingFormUrl: 'https://forms.gle/YwJaQDQS7MSpxYQm6',
    programmingSupportPrintUrl: 'https://www.canva.com/design/DAG4LUvH4rY/kc3eeFLc5z_YBz2IdLeSRg/view?utm_content=DAG4LUvH4rY&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hbdfb901359',
    programmingApDojoUrl: 'https://xgf.nu/GT5Jx',
    fallbackIcon: '🏠',
    sdgsGoal: 1
  },
  4: {
    ...
    sdgsWorkUrl: 'https://youtu.be/C_gTPDP2SrU',
  ...
  5: {
    ...
    sdgsWorkUrl: 'https://youtu.be/z8JuaasrZPI',
    sdgsFormUrl: 'https://forms.gle/9uGZFJvV4gyy4CYHA',
    sdgsSupportPrintUrl: 'https://www.canva.com/design/DAG8ThNUYzA/wMRxoIM_s_YJeq_-rV5zwQ/edit?utm_content=DAG8ThNUYzA&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton',
    sdgsStageDownloadUrl: 'https://xgf.nu/kB0bN',
    programmingWorkUrl: 'https://youtu.be/dcLLafLy6B8',
    programmingFormUrl: 'https://forms.gle/JuFsJJXXQxkXPiDr9',
    programmingSupportPrintUrl: 'https://www.canva.com/design/DAG-7IdQ3BE/SvfCdqrHjlETF5iM0VvsjQ/view?utm_content=DAG-7IdQ3BE&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hc873e05507',
    programmingApDojoUrl: 'https://example.com',
    fallbackIcon: '⚕️',
    sdgsGoal: 3
  },
  6: {
  ...
  7: {
    ...
    sdgsWorkUrl: 'https://youtu.be/bOF1SdQHcIQ',
    sdgsFormUrl: 'https://forms.gle/G6uWEsFc3tJVMfn7A',
    sdgsSupportPrintUrl: 'https://www.canva.com/design/DAHCOAdkwuo/_pILPHLZjcAVbnmKK47hRA/edit?utm_content=DAHCOAdkwuo&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton',
    sdgsStageDownloadUrl: 'https://xgf.nu/mLhCJ',
  ...
  8: {
    ...
    sdgsWorkUrl: 'https://youtu.be/0zSTeX8hc7o',
    sdgsFormUrl: 'https://forms.gle/pXwvy3pLMKoTgo8u9',
    sdgsSupportPrintUrl: 'https://canva.link/apkrp3g89codwpc',
  ...
  9: {
    ...
    sdgsWorkUrl: 'https://youtu.be/5iig6lWqWvw',
    sdgsFormUrl: 'https://forms.gle/XUzZFoagzwjNyBSg8',
    sdgsSupportPrintUrl: 'https://canva.link/f120cn12uerfbkh',
