...
export default function WorldDataModal({ isOpen, onClose }: WorldDataModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* モーダルコンテンツ */}
      <div className="relative bg-white minecraft-modal max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* ヘッダー */}
        <div className="minecraft-modal-header">
          <h2 className="text-2xl font-bold text-minecraft-brown flex items-center gap-2">
            📁 ワールドデータについて
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="minecraft-modal-footer">
          <button 
            onClick={onClose}
            className="minecraft-button minecraft-button-primary"
          >
            わかった！
          </button>
        </div>
